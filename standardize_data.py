...
from bacteria_data import BASE, DEFAULT_SOURCES, RAW_DIR, STANDARDIZED_DIR, SUMMARY_COLUMNS, read_data
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=Path, default=STANDARDIZED_DIR)
    args = parser.parse_args()
    for source in args.sources or [RAW_DIR / name for name in DEFAULT_SOURCES]:
